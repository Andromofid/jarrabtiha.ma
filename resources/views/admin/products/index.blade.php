    ...
    <form action="{{ route('admin.products.index') }}" method="GET" class="mt-8 rounded-[1.75rem] border border-border bg-cream p-5 sm:p-6">
        <div class="grid gap-4 md:grid-cols-1">
            ...
            <div class="flex items-start  gap-2">
                <input type="checkbox" class="text-primary" name="created_by_client" id="created_by_client" value="1">
                <label for="created_by_client" class="mb-2 block text-sm font-semibold text-ink">Created by Client</label>
            </div>
        </div>
