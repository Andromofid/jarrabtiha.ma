<div class="my-4 rounded-2xl border border-border bg-white p-6 shadow-soft" id="review-form">
    ...
    <div class="mt-8 rounded-2xl border border-border bg-cream p-8 text-center">

        <div class="mx-auto mb-5 flex h-16 w-16 items-center justify-center rounded-full bg-pink-soft/40 text-3xl">
        ...
        <p class="mt-3 text-sm leading-6 text-ink-soft max-w-md mx-auto">
        ...
        <div class="mt-6 flex flex-col justify-center gap-3">
            <div class="flex flex-col gap-3 sm:flex-row sm:justify-center">
                <a
                    ...
                    class="rounded-xl bg-primary px-6 py-3 font-semibold text-white transition hover:bg-ink">
                    Se connecter
                </a>
            ...
            <a
                ...
                class="flex md:w-[50%] w-full items-center justify-center gap-2 mx-auto rounded-xl border border-border py-3 font-semibold text-ink-soft transition hover:bg-ink-soft/10">
    ...
    <form method="POST" action="{{ route('reviews.store', $product) }}" class="mt-8">
        ...
        <div
            ...
            <div class="rounded-2xl border border-border bg-cream p-6 text-center">
                <p class="text-sm font-semibold text-ink mb-4">
                ...
                <div class="flex justify-center gap-3">
                    <template x-for="star in 5" :key="star">
                        <button
                            ...
                            :class="star <= rating ? 'text-primary' : 'text-primary-light'">
                            ★
                        </button>
                    </template>
                </div>
            ...
            <div>
                ...
                <textarea
                    ...
                    class="w-full rounded-2xl border border-border bg-cream px-4 py-3 text-sm text-ink placeholder:text-ink-light focus:border-primary focus:ring-1 focus:ring-primary focus:outline-none resize-none transition">{{ old('body') }}</textarea>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select
                        ...
                        required
                        class="w-full rounded-xl border border-border bg-cream px-4 py-3 text-sm text-ink focus:border-primary focus:ring-1 focus:ring-primary focus:outline-none transition">
                ...
                <div>
                    ...
                    <label class="flex items-center gap-3 w-full rounded-xl border border-border bg-cream px-4 py-3 cursor-pointer hover:border-primary transition">
                        <input
                            type="checkbox"
            ...
            <button
                type="submit"
                class="w-full rounded-2xl bg-primary py-4 text-sm font-semibold text-white shadow-md hover:bg-primary-hover transition-colors duration-200">
                Publier mon avis
            </button>
