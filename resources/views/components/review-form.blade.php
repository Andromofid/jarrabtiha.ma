    ...
    <div class="mt-8 rounded-2xl border border-[#F2D0C4] bg-[#FDF8F5] p-8 text-center">
        ...
        <div class="mt-6 flex flex-col justify-center gap-3">
            ...
            <a
                ...
                class="flex w-[50%] items-center justify-center gap-2 mx-auto rounded-xl border border-border py-3 font-semibold text-brown-soft transition hover:bg-brown-soft/10">
