<section>
    ...
    @else
        <form method="post" action="{{ route('password.update') }}" class="mt-8 space-y-6">
            ...
            <div>
                <label for="update_password_current_password" class="text-sm font-semibold text-ink">Mot de passe actuel</label>
                <input
                    id="update_password_current_password"
                    name="current_password"
                    type="password"
                    autocomplete="current-password"
                    class="mt-2 block w-full rounded-2xl border border-border bg-cream px-5 py-3 text-sm text-ink outline-none transition focus:border-primary focus:ring-0"
                />
                <x-input-error :messages="$errors->updatePassword->get('current_password')" class="mt-2" />
            </div>

            <div>
                <label for="update_password_password" class="text-sm font-semibold text-ink">Nouveau mot de passe</label>
                <input
            ...
            <div>
                <label for="update_password_password_confirmation" class="text-sm font-semibold text-ink">Confirmer le mot de passe</label>
                <input
