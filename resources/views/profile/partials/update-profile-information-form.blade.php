    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-8 space-y-6">
        ...
        <div>
            ...
            <input
                ...
                autofocus
                autocomplete="name"
                class="mt-2 block w-full rounded-2xl border border-border bg-cream px-5 py-3 text-sm text-ink placeholder:text-ink-light outline-none transition focus:border-primary focus:ring-0"
            />
        ...
        <div>
            <div class="flex items-center justify-between gap-3">
                <label for="email" class="text-sm font-semibold text-ink">Adresse e-mail</label>
            ...
            <input
                ...
                class="mt-2 block w-full rounded-2xl border border-border bg-cream px-5 py-3 text-sm text-ink placeholder:text-ink-light outline-none transition focus:border-primary focus:ring-0 {{ $user->google_id ? 'cursor-not-allowed opacity-60' : '' }}"
            />
